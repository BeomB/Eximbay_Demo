  ...
  return (
    <>
      ...
      <div className="main">
        ...
        <h4 className="title">TEST - Payment</h4><br />
            ...
            <div className="accordion mb-2">
              <div className="accordion-item">
                <h2 className="accordion-header" id="headingSettings">
                  <button className="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#collapseSettings" aria-expanded="true" aria-controls="collapseSettings">
                    settings
                  </button>
                </h2>
